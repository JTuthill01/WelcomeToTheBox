...
void ANavySMG::WeaponFire()
{
	...
	if (IsValid(WeaponAnimInstance))
	{
		...
		GetWorldTimerManager().SetTimer(WeaponFireTimerHandle, this, &ANavySMG::ResetCanFireOrReload, WeaponFireTimer, false);
	}
...
void ANavySMG::WeaponReload()
{
	...
	if (IsValid(WeaponAnimInstance))
	{
		...
		GetWorldTimerManager().SetTimer(WeaponReloadTimerHandle, this, &ANavySMG::ResetCanFireOrReload, WeaponReloadTimer, false);
	}
...
void ANavySMG::ResetCanFireOrReload()
{
	bIsReloading = false;
	bIsFiring = false;

#include "Weapons/NavySMG/NavySMG.h"
...
void ANavySMG::WeaponFire()
{
	...
	if (IsValid(WeaponAnimInstance))
	{
		...
		UNiagaraFunctionLibrary::SpawnSystemAtLocation(GetWorld(), BoxerInstance->AmmoEjectFXMap[EWeaponName::EWN_NavySMG], EjectTransform.GetTranslation(), EjectQuat.Rotator());
		UNiagaraFunctionLibrary::SpawnSystemAtLocation(GetWorld(), BoxerInstance->FireFXMap[EWeaponName::EWN_NavySMG], FireTransform.GetTranslation(), FireQuat.Rotator());
	}

...
enum class EWeaponName : uint8 { EWN_NONE UMETA(DisplayName = "None"), EWN_TT33 UMETA(DisplayName = "TT33"), EWN_AK47 UMETA(DisplayName = "AK47"), EWN_AmericanShotgun UMETA(DisplayName = "American Shotgun"), EWN_BelgianAR UMETA(DisplayName = "Belgian AR"),
	...
	EWN_L86 UMETA(DisplayName = "L86"), EWN_AK74 UMETA(DisplayName = "AK74"), EWN_M4A1 UMETA(DisplayName = "M4A1"), EWN_NavySMG UMETA(DisplayName = "Navy SMG"), EWN_ItalianShotgun UMETA(DisplayName = "Italian Shotgun"),
...
UENUM(BlueprintType)
enum class EWeaponType : uint8 { EWT_None UMETA(DisplayName = "None"), EWT_Pistol UMETA(DisplayName = "Pistol"), EWT_Rifle UMETA(DisplayName = "Rifle"),
